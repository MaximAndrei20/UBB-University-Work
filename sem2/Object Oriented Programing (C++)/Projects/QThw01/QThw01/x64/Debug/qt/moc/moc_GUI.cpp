...
void GUI::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (GUI::*)()>(_a, &GUI::undoTriggered, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (GUI::*)()>(_a, &GUI::redoTriggered, 1))
            return;
    }
}
...
// SIGNAL 0
void GUI::undoTriggered()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void GUI::redoTriggered()
{
