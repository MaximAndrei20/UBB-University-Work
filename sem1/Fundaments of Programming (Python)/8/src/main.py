...
def main():
    ...
    if properties["repository"] == "inmemory":
        ...
        assignments_service = AssignmentService(assignments_repo)
        grades_service = GradeService(grades_repo)

        add_data(students_service, assignments_service, grades_service)

        ui = UI(students_service, assignments_service, grades_service)
        ui.run()
        ...
        students_service = StudentService(student_repo)
        assignments_service = AssignmentService(assignment_repo)
        grades_service = GradeService(grade_repo)
